...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JniUtils jniBean = new JniUtils();

        tv.setText(jniBean.stringFromJNI()
         + "\n" + jniBean.testCallMethod() + "\n" + JniUtils.testStaticCallMethod()
         + "\n" + JniUtils.testStaticCallStaticMethod()
         + "\n" + jniBean.testCallFatherMethod() + "\n" + jniBean.testCallChildMethod()
         + "\n" + jniBean.testNewJavaDate());
